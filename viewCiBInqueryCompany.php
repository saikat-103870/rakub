  ...
  <thead class="thead-light">
    <tr>
      <th>Fee Amount</th> <th>:</th> <td><?php echo $voucherAmount; ?></td> 
		...
		<th> Date</th><th>:</th> <td><?php echo empty($voucherDate)==false? date("d-m-Y",strtotime(str_replace('/', '-', $voucherDate))): $voucherDate; ?></td> 
 ...
 <tr>
  ...
  <thead class="thead-light">
    <tr>
	 ...
	 <div class="panel panel-default" >
		<div class="panel-heading" style="background-color:#09937c;"> <span style="color: white; font-size:16px;">Present Address</span>
