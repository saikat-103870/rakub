...
$data=mysqli_query($conn,'select * from `form1`');
while($row=mysqli_fetch_array($data)){
	//Personal Information
	$pdf->Row(Array('Employee PIN/Personnel No.',':',empty($row['FISubjCode'])? ' ': $row['FISubjCode'],
		'LoanType',':',empty($row['LoanType'])? ' ': $row['LoanType']));
