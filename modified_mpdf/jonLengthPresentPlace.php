...
function printTable(&$result) //mysqli result set
{
	...
	$txt.='<table border ="1" cellspacing="0" cellpadding="10">
			<tr>
				...
				<th>Name</th>
				<th>Designation</th>
				<th>Plosting Place</th>
				<th>joining Date</th>
				<th>Job Length in current Place</th>
		</tr>';
...
if(trim($_POST['yearno'])=='0')
{
	echo '<br><br><br><br><br><br><center><div style="color: red;font-size:18px;">Please select No. of Years</div>';
	echo '<a href="jonLengthPresentPlace.php" class="btn btn-lg">Back</a></center>';
	exit;
}
	
$noDay=($_POST['yearno'])*365;
...
where datediff(CURDATE(),tb.joiningDate)>=".$noDay."
...
$mpdf->Ln(5);
$mpdf->WriteHTML('List of Employee working more than '.$_POST['yearno'].' years in current working place');
$mpdf->Ln();
...
<div class="panel-heading" style="background-color:#008836;color: white; font-size:16px;">Select Number of Year</div>
<div class="panel-body" style="border:1px solid green;  background-color:#f0f5f5;">
<div class="form-group">
	  
	  <select class="form-control empno" id="empno" name="yearno">
