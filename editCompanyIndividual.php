...
//echo $trNo;
//exit();
include("editcmpIndividualSave.php");
?>
<!DOCTYPE html>
<br><br><br>
<html>
...
<div class="container">
     ...
     <div class="wrapper"><div style="text-align:center;font-size:2vw;background-color:green;color:white;width:100%;height:48px;padding-top:7px;margin-bottom:10px">Owner Form</div>
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" id="individual" method="POST" name= "form1" role="form" id="register-form" autocomplete="off" onsubmit="return validateForm()" enctype="multipart/form-data" >
 ...
 <div class="body_style">
		...
		<label style="color: magenta;font-size:21px;margin-left:750px" for="Tracking No">Tracking No - <?php echo $trNo1; ?> </label>
...
<input type='hidden' value='<?php echo $trNo; ?>' name="txttrNo"  />
<input type='hidden' value='<?php echo $trNo1; ?>' name="txttrNo1"  />
...
<p align="right">
<span style="margin-right:8px;"> &nbsp; <button type="submit" id="back" name="back" class="btn btn-lg btn-success">Back</span></button> </span>
<span style="margin-right:8px;"> &nbsp; <button type="submit" id="save" name="save" class="btn btn-lg btn-warning"> Update<span class='glyphicon glyphicon-step-forward'></span></button> </span>
