...
if(isset($_GET['gtrNo']))
{
	...
	{
		echo '<center>';
		echo '<h2><br><br><br><br><span style="color: red;">Already sent to Zonal Manager.</span></h2>';
...
if (isset($_POST['SubmitZM']))
{
	$trN=$_POST['trNo'];
	$trNo='';
	//echo '<br><br><br><br><br><br><br><br>dfdfdf'.$trNo; exit;
	$sql = "UPDATE `inquiry` SET  `status`=2 where `TrackingNo`='$trN'";

if (mysqli_multi_query($conn, $sql))
        {
			echo '<center>';
			echo '<h2><br><br><br><br><span style="color: green;">Successfully Send to Zonal Manager.</span></h2>';
  ...
  <thead class="thead-light">
    <tr>
      <th>Fee Amount</th> <th>:</th> <td><?php echo $voucherAmount; ?></td> 
		...
		<!--<p style="font-size:20px; text-decoration: none;color: #f60050 ;">Individual Data:</p>
...
{	
 ...
 <tr>
	 ...
	 <div class="panel panel-default" >
		<div class="panel-heading" style="background-color:#0ba4b8;"> <span style="color: white; font-size:16px;">Permanent Address</span>
...
<span style="margin-left:10px;"> &nbsp; <button type="submit" id="SubmitZM" name="SubmitZM" class="btn btn-lg btn-success">Submit to Zonal Manager <span class='glyphicon glyphicon-step-forward'></span></button> </span>
