...
if (isset($_POST['save']))
{
	...
	if(!empty(trim($_POST["voucherDate"])))
		{
...
$targetDir = "uploads/";
		...
		`FacDistrict`,`FacCountry`,`SecType`,`SecCode`,`TelephoneNumber`,`UploadMoneyReceipt`,`UploadPromiseLetter`,`UploadOtherDocs`)
		values ('$trNo','$InstitutionType','$Title','$TradeName','$LegalForm','$Etin',
			...
			'$SecCode','$TelephoneNumber','$fileName1','$fileName2','$fileName3')";
...
$odup='';
	...
	if(($FinTypeID=="Term Loan")OR($FinTypeID=="Other installment contract"))
		...
		else
		{
			...
			FacStreet='$FacStreet',FacPostal='$FacPostal',FacDistrict='$FacDistrict',FacCountry='$FacCountry',
			SecType='$SecType',SecCode='$SecCode', ".$mrup." ".$plup."
			".$odup." TelephoneNumber='$TelephoneNumber',voucherAmount='$voucherAmount',voucherNumber='$voucherNumber',voucherDate='$voucherDate',contractHistory='$contractHistory',contractPhase='$contractPhase' where TrackingNo='$trNo'";
        ...
        {
			//echo '<br><br><br><br><br><br><br><br>'.$Title; exit;
            echo '<center>';
            //echo '<h2><br><br><br><br><span style="color: green;">Successfully update Information with Tracking No-'.$trNo.'</span></h2>';
           ...
           // echo '</center>';
			 echo "<a class='btn btn-info btn-lg ' href='editCompany.php?gtrNo=$trNo'><span class='glyphicon glyphicon-edit'></span>Edit Company</a><br><br>";
			 echo "<a class='btn btn-danger btn-lg' href='editInquiryCompany.php?gtrNo=$trNo'><span class='glyphicon glyphicon-edit'></span>Edit Owner List</a><br><br>";
		     ...
		     echo "<a class='btn btn-success btn-lg ' href='home.php'><span class='glyphicon glyphicon-home'></span> Home</a><br><br>";
...
<!--<p align= "right"<p style="color:red;text-align:right;font-size:20px">Branch Code:<?php echo $brCode;?></p>--->
   ...
   <form action="<?php echo $_SERVER['PHP_SELF']; ?>" id="company" method="post" name= "form2" role="form" id="register-form" autocomplete="off"onsubmit="return validateForm()" enctype="multipart/form-data">
    ...
    <li class="active"><a data-toggle="tab" role="tab" href="company.php" id="company">Company</a></li>
		<li ><a data-toggle="tab" role="tab" href="propietorship.php" id="proprietorship" name= "proprietorship" >Propietorship</a></li>
...
<section>	
	...
	<div class="form-group col-lg-3" style="padding-top:15px;"> 
			...
			<div class="form-group">
			  ...
			  <input type="text" name="BusPostal" id="BusPostal" maxlength="4" value="<?php echo $BusPostal; ?>" class="form-control" onkeydown="javascript: return event.keyCode == 69 ? false : true"  />
			</div>
        </div>
		<div class="form-group col-lg-3" style="padding-top:15px;">     
			  <div class="form-group">
     ...
     <div class="row" style="background-color:#f1fdef ;">
		...
		<div class="form-group col-lg-3"  style="padding-top:15px;" > 
			<div class="form-group">
			  ...
			  <input type="text" name="FacPostal" id="FacPostal" maxlength="4"value="<?php echo $FacPostal; ?>" onkeydown="javascript: return event.keyCode == 69 ? false : true" class="form-control"  />
			</div>
        </div>
		<div class="form-group col-lg-3" style="padding-top:15px;">     
			  <div class="form-group">
 ...
 <select class="form-control" id="FacCountry" name='FacCountry'>
     ...
     <div class="row" style="background-color:#dbf3ef">
		...
		<div class="form-group col-lg-3" style="padding-top:15px;">     
			  ...
			  <input type="text" name="TelephoneNumber" id="TelephoneNumber" maxlength="15"  required ="true" value="<?php echo $TelephoneNumber; ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')" class="form-control" />
			 </div>
		</div>
						<div class="form-group col-lg-3" style="padding-top:15px;">     
...
<span style="margin-right:8px;"> &nbsp; <button type="submit" id="save" name="save" class="btn btn-lg btn-success">Update<span class='glyphicon glyphicon-step-forward'></span></button> </span>
